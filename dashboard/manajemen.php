...
<head>
    ...
    <title>Dashboard Manajemen - Sistem Pendukung Keputusan</title>
    <link rel="stylesheet" href="../assets/css/app.css">
</head>
<body class="min-h-screen bg-canvas p-6">
    <main class="max-w-3xl mx-auto bg-white border border-gray-200 rounded-lg p-8">
        <h1 class="text-xl font-bold text-gray-900">Dashboard Manajemen</h1>
        <p class="mt-2 text-gray-600">
            Selamat datang, <?= htmlspecialchars((string) $_SESSION['nama'], ENT_QUOTES, 'UTF-8') ?>.
            Halaman ini adalah placeholder — lakukan pembobotan AHP dan lihat hasil perangkingan TOPSIS di sini.
        </p>
